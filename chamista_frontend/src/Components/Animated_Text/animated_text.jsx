      ...
      <div className=" container-text">
        <div className="anim-text">
          ...
          <ul className="tags-cloud">
            <li className="tag">
              <span className="wrap">Chemistery</span>
            </li>
            <li className="tag">
              <span className="wrap">Physics</span>
            </li>
            <li className="tag">
              <span className="wrap">Maths</span>
            </li>
            <li className="tag">
              <span className="wrap">O-Levels</span>
            </li>
            <li className="tag">
              <span className="wrap">A-Levels</span>
            </li>
            <li className="tag">
              <span className="wrap">Metric</span>
            </li>
            <li className="tag">
              <span className="wrap">Intermediate</span>
            </li>
            <li className="tag">
              <span className="wrap">Computer</span>
            </li>
            <li className="tag">
              <span className="wrap">Biology</span>
            </li>
            <li className="tag">
              <span className="wrap">Blogs</span>
            </li>
            <li className="tag">
              <span className="wrap">Books</span>
            </li>
            <li className="tag">
              <span className="wrap">Notes</span>
            </li>
            <li className="tag">
              <span className="wrap">Lectures</span>
            </li>
            <li className="tag">
              <span className="wrap">10th Grade</span>
            </li>
            <li className="tag">
              <span className="wrap">11th Grade</span>
            </li>
            <li className="tag">
              <span className="wrap">12th Grade</span>
            </li>
            <li className="tag">
              <span className="wrap">9th Grade</span>
            </li>
            <li className="tag">
              <span className="wrap">Mathmetics</span>
            </li>
          </ul>
        </div>
        <div>
